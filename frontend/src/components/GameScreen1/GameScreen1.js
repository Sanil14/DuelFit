  ...
  return (
    <section className="h-screen bg-gray-900">
      <div className="flex flex-row justify-around h-6/12">
        ...
        <div className="bg-green-400 w-3/12 h-28 text-white top-10 relative mx-10 p- flex justify-center items-center">
          <h className="text-3xl">Timer</h>
        </div>
      </div>
      <div className="flex flex-row h-6/12">
        <div className="bg-blue-300 w-4/12 mx-40 my-40 flex flex-col justify-center text-center text-2xl">
