...
const LandingPage = () => {
  return (
    <section class="text-gray-400 bg-gray-900 body-font h-screen">
      <div class="container mx-auto flex px-24 py-40 md:flex-row flex-col items-center p">
        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-4/6 mb-10 md:mb-0">
          <img class="object-cover object-center rounded w-96" alt="hero" src={Image} />
        </div>
        <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">DuelFit</h1>
          <p class="mb-8 leading-relaxed">Duel your way into the fittest version of yourself with our brand new webapp!</p>
          ...
          <div class="flex lg:flex-row md:flex-col text-gray-300 my-10">
